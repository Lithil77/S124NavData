...
import {
    ...
    from '../OpenLayersUtils/OpenLayers.js';
import { S1412windLayer, nodeServerUrl } from '../appConfig.js';
import { useProductFilter } from './ProductFilterContext.jsx';
import { OLMapContext } from './OlMapContext.jsx';
        ...
        try {
            ...
            const geometryFeaturesData = intersectingFeatures.map(feature => {
                ...
                if (layerName === S1412windLayer) {
                    ...
                    console.log('selectedCalendarDate', selectedCalenderDate)
