...
import { initializeDrawAndVectorLayers } from '../Utils/Utils';
import { RunSailTimerApi } from '../../../../../GeoServerUtils/SailTimer';
import { getDatesOFS1412 } from '../../../../../GeoServerUtils/GetDatesOfS1412';
...
function GeoTools() {
    ...
    const selectGeometryFeature = async (drawType, vectorFillStyle, vectorStrokeStyle) => {
        ...
        const dynamicUrl = `${nodeServerUrl}/getProducerCodes`;
